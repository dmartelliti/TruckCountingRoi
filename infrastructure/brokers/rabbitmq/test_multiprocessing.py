...
def run_consumer(config):
    ...
    try:
        # El customer ya tiene un loop bloqueante internamente.
        consumer.start_consuming(handle_message)

    # Para cerrar correctamente la conexion, usando Ctrl+C.
